<template>
    <div class="py-4 container-fluid">
        <h6>Página de Cálculo de Salários</h6>
        <div class="row g-2 align-items-center d-flex">
            <div class="col-auto mb-3 d-flex align-items-center">
                <input type="text" v-model="searchEmployee" @input="validateSearch" class="form-control form-control-md"
                    placeholder="Pesquise por funcionário" style="width: 350px;" data-bs-toggle="tooltip"
                    title="Pesquisar" aria-label="Pesquise por funcionário" />
            </div>
            <div class="col-auto mb-3 d-flex">
                <input type="month" v-model="filterMonth" class="form-control form-control-md" title="Filtrar por mês" />
            </div>
            <div class="col-auto mb-3 d-flex">
            ...
            <div class="col-auto d-flex">
                <button class="btn btn-success btn-md" @click="searchSalaries" aria-label="Pesquisar salários">
            ...
            <div class="col ms-auto d-flex">
                <button id="calculateSalary" class="btn btn-success" @click="calculateAllSalaries">Calcular Todos os Salários</button>
            </div>
        </div>
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center justify-content-center mb-0 table-sm">
                                <thead>
                                    <tr>
                                        <th @click="sortData('employeeId')">ID Funcionário</th>
                                        <th @click="sortData('employeeName')">Nome</th>
                                        <th @click="sortData('baseSalary')">Salário Base</th>
                                        <th @click="sortData('taxes')">Impostos</th>
                                        <th @click="sortData('benefits')">Benefícios</th>
                                        <th @click="sortData('absences')">Faltas</th>
                                        <th @click="sortData('netSalary')">Salário Líquido</th>
                                        <th>Ações</th>
                                    </tr>
                                </thead>
                                <tbody>
